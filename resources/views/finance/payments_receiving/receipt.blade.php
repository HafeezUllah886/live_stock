                            ...
                            <div class="card-body p-4">
                               <table style="width:100%;">
                                <tr>
                                    ...
                                    <td class="border-2 border-top-0 border-start-0 border-end-0 text-center p-4 pb-1">{{$payment->depositer->title}}</td>
                                </tr>
                                <tr>
                               ...
                               <table style="width:100%;">
                                <tr>
                                    ...
                                    <td class="border-2 border-top-0 border-start-0 border-end-0 text-center p-4 pb-1" >{{number_format(spotBalanceBefore($payment->receiverID, $payment->refID),2)}}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="border-2 border-top-0 border-start-0 border-end-0 text-center p-4 pb-1" >{{number_format(spotBalance($payment->receiverID, $payment->refID),2)}}</td>
                                </tr>
                               </table>
