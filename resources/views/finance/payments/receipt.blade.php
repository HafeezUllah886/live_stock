                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0 mt-sm-0 mt-3">
                                    ...
                                    <p> <span class="text-muted text-uppercase fw-semibold mt-0 m-0 p-0">Receipt Ref #
                                        </span><span class="fs-14 m-0 p-0">{{ $payment->refID }}</span></p>
                                    <p> <span class="text-muted text-uppercase fw-semibold mt-0 m-0 p-0">Date : </span><span
                                            class="fs-14 m-0 p-0">{{ date('d M Y', strtotime($payment->date)) }}</span></p>
                                </div>
                            </div>
                        </div>
                        <!--end card-header-->
                    ...
                    <div class="col-9">
                        <div class="card-body p-4">
                            <table style="width:100%;">
                                <tr>
                                    <td style="width:30%;" class="p-4 pb-1"><strong>Payment To</strong></td>
                                    <td class="border-2 border-top-0 border-start-0 border-end-0 text-center p-4 pb-1">
                                        {{ $payment->receiver->title }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="border-2 border-top-0 border-start-0 border-end-0 text-center p-4 pb-1">
                                        Rupees {{ numberToWords($payment->amount, 2) }} Only</td>
                                </tr>
                                <tr>
                                    <td style="width:30%;" class="p-4 pb-1"><strong>Paid By</strong></td>
                                    <td class="border-2 border-top-0 border-start-0 border-end-0 text-center p-4 pb-1">
                            ...
                            <table style="width:100%;">
                                <tr>
                                    <td style="width:80%;" class="p-4 pb-1 text-end" colspan="3"><strong>Previous
                                            Balance: </strong></td>
                                    <td class="border-2 border-top-0 border-start-0 border-end-0 text-center p-4 pb-1">
                                        {{ number_format(spotBalanceBefore($payment->receiverID, $payment->refID), 2) }}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="border-2 border-top-0 border-start-0 border-end-0 text-center p-4 pb-1">
                                        {{ number_format(spotBalance($payment->receiverID, $payment->refID), 2) }}</td>
                                </tr>
                            </table>
