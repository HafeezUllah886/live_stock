                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mt-2">
                                    <label for="account_id">Paid from (Balance: <span id="accountBalance">0</span>)</label>
                                ...
                                <div class="form-group mt-2">
                                    <label for="receiver_id">Received By (Balance: <span id="accountBalanceReceiver">0</span>)</label>
                                    <select name="receiver_id" id="receiver_id" onchange="getBalanceReceiver()" required
                                        class="selectize">
                                        <option value=""></option>
                                        @foreach ($receivers as $receiver)
                                            <option value="{{ $receiver->id }}">{{ $receiver->title }}
                                                ({{ $receiver->category }})</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group mt-2">
...
@section('page-js')
    ...
    <script>
        ...
        function getBalanceReceiver() {
            var id = $("#receiver_id").find(":selected").val();
            $.ajax({
                url: "{{ url('/accountbalance/') }}/" + id,
                method: 'GET',
                success: function(response) {
