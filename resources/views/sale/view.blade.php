                            ...
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <h5 class="fs-14 mb-0">{{$sale->customerID == 3 ? $sale->customerName : ""}}</h5>
                                    </div>
                                    <!--end col-->
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-end p-1 m-1">{{number_format($sale->details->sum('qty'), 2)}}</th>
                                                    <th class="text-end p-1 m-1">{{number_format($sale->details->sum('amount'), 2)}}</th>
                                                </tr>
                                            </table><!--end table-->
                                        </div>
                                    </div>
