...
class StockAdjustmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try
        {
            ...
            {
               createStock($request->productID, $request->qty, 0, $request->date, "Stock-In: $request->notes", $ref);
            }
            else
            {
                createStock($request->productID, 0, $request->qty, $request->date, "Stock-Out: $request->notes", $ref);
            }
